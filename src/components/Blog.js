            ...
            <div className='box-blog'>
                ...
                <div className="all">
                    <div className="blog-row">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src={require("../images/restapi.gif")} alt="person-typing" width='440'/>
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src={require("../images/callback.gif")} alt="girl-eating" width='490'/>
                                <div class="description">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src={require("../images/teamwork.png")} alt="three-points-talking" width='470'/>
                                <div class="description">
                    ...
                    <div className="blog-row">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src="https://miro.medium.com/max/640/1*74ayWFrX2ZDM-ToJjKkBAQ.png" alt="database-sql" width='410'/>
                                <div class="description">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src="https://miro.medium.com/max/720/1*55LlF1dtoBK9H7ZMW1Fs-Q.png" alt="pair-programming" width='450'/>
                                <div class="description">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src={require("../images/terminal.png")} alt="terminal" width='470'/>
                                <div class="description">
                    ...
                    <div className="blog-row">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src="https://miro.medium.com/max/468/1*bADvRNKI9ShBVPXLxeURCA.png" alt="Tayanne-scientist" width='180'/>
                                <div class="description">
                        ...
                        <div className="blog-column">
                            <div className='blog-card'>
                                <img src={require("../images/tdd.png")} alt="tdd-cycle" width='490'/>
                                <div class="description">
